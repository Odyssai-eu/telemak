...
let package = Package(
    ...
    dependencies: [
        ...
        // decoding, and the hy_v3 (HunYuan-3) base model. Tracks upstream
        // main otherwise. feat/hy_v3 = pre-moe superset + hy_v3 base, no MoE-MTP.
        .package(url: "https://github.com/Odyssai-eu/mlx-swift-lm", branch: "feat/model-gap"),
